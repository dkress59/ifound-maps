...
const ImprintHTML = (props) => {
	return (
		<section id="legal" className="container-fluid row">

			<article id="disclaimer" className="text-center mt-5 pb-2 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
			...
			<article id="imprint" className="mt-5 pb-1 col-lg-8 offset-lg-2">
			...
			<article id="privacyPolicy" className="mt-5 pb-1 col-lg-8 offset-lg-2">
